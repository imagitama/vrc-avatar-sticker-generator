...
public class VRCAvatarStickerGeneratorEditor : Editor 
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(serializedObject.FindProperty("doVideo"), new GUIContent("Video"));
        ...
        if (serializedObject.FindProperty("doVideo").boolValue == true) {
            CustomGUI.LineGap();
            CustomGUI.LargeLabel("Step 2: Settings");
            CustomGUI.SmallLineGap();

            EditorGUILayout.PropertyField(serializedObject.FindProperty("frameLimit"), new GUIContent("Frame Limit"));
            CustomGUI.ItalicLabel("The number of frames to record (always 30 FPS) default is 90 (3 seconds)");
            CustomGUI.SmallLineGap();
        } else {
